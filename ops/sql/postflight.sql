...
BEGIN READ ONLY;
SELECT version,success FROM flyway_schema_history WHERE version IN ('1','2','3','4','5','6','7','8') ORDER BY installed_rank;
...
DO $$ BEGIN
  IF (SELECT count(*) FROM flyway_schema_history WHERE version IN ('1','2','3','4','5','6','7','8') AND success)<>8 THEN
    RAISE EXCEPTION 'Expected application migrations V1-V8';
  END IF;
END $$;
COMMIT;
