...
BEGIN READ ONLY;
SELECT version,success FROM flyway_schema_history WHERE version IN ('1','2','3','4','5','6','7','8','9') ORDER BY installed_rank;
...
DO $$ BEGIN
  IF (SELECT count(*) FROM flyway_schema_history WHERE version IN ('1','2','3','4','5','6','7','8','9') AND success)<>9 THEN
    RAISE EXCEPTION 'Expected application migrations V1-V9';
  END IF;
END $$;
COMMIT;
